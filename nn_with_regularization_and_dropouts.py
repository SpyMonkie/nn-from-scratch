...
from dropout_layers import Layer_Dropout
...
def main():
    ...
    print(f'Validating model with new data...')
    # Validate the model
    # Create test data
    ...
    # Perform a forward pass through the second Dense layer, takes outputs of the first activation function
    dropout1.forward(activation1.output)

    # Perform a forward pass through the activation/loss functions, takes the output of the second dense layer
