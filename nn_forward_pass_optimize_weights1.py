...
# optimization based on iteration of random weights and biases
# until loss is below a certain threshold
# this is not a good way to optimize weights, but it is a way to test the
